...
import 'package:shop_emoji/detail.dart';
import 'package:shop_emoji/foodTabs.dart';
...
class _FeedState extends State<Feed> with SingleTickerProviderStateMixin{
            ...
            child: ListView(
              ...
              children: [
                ...
                _buildListItem('Chips', 'assets/fries.png', '15',
                    Color(0xFFC2E3FE), Color(0xFF6A8CAA)),
                _buildListItem('Donuts', 'assets/doughnut.png', '15',
                    Color(0xFFD7FADA), Color(0xFF56CC7E)),_buildListItem('Hamburger', 'assets/burger.png', '21',
                    Color(0xFFFFE9C6), Color(0xFFDA9551)),
                _buildListItem('Chips', 'assets/fries.png', '15',
                    Color(0xFFC2E3FE), Color(0xFF6A8CAA)),
                _buildListItem('Donuts', 'assets/doughnut.png', '15',
  ...
  _buildListItem(String foodName, String imgPath, String price, Color bgColor, Color textColor) {
    return Padding(
      ...
      child: InkWell(
        onTap: () {
          Navigator.of(context).push(MaterialPageRoute(builder: (context) => DetailedPage(heroTag: foodName,
            foodName: foodName, pricePerItem: price, imgPath: imgPath,)));
        },
        child: Container(
          height: 175.0,
          width: 150.0,
